...
const SubjectModeSelection = () => {
  ...
  // Base parameters to append to URLs
  const baseParams = `iitm_subject=${subjectId}&name=${subjectName}&type=${examType}`;

  // Fetch the Level Name details
    ...
    <div className="min-h-screen bg-[#09090b] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="z-10 w-full max-w-5xl space-y-12">
        ...
        <div className="text-center space-y-4 relative">
          <Button 
            variant="ghost" 
            onClick={() => navigate(-1)} // Go back to OPPE Selection
        ...
        <div className="grid md:grid-cols-2 gap-8 w-full max-w-4xl mx-auto">
          ...
          <div 
            ...
            onClick={() => navigate(`/practice?${baseParams}`)}
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground mb-8 flex-1 leading-relaxed">
                Practice <strong>{decodedExamType}</strong> assignments for {decodedSubject}. Instant grading and unlimited attempts.
              </p>
              <Button 
                size="lg"
          ...
          <div 
            ...
            onClick={() => navigate(`/exam?${baseParams}`)}
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-muted-foreground mb-8 flex-1 leading-relaxed">
                Take the <strong>{decodedExamType}</strong> exam for {decodedSubject}. Strict proctoring and time limits apply.
              </p>
              <Button 
                size="lg"
                variant="outline"
