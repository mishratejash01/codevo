    ...
    <div className="min-h-screen bg-[#F9F7F2] text-[#1a1a1a] font-sans selection:bg-black/10">
      ...
      <header className="relative pt-24 pb-12 px-6 md:px-16 lg:px-24 z-10 border-b border-black/5">
        <div className="max-w-[1800px] mx-auto">
            ...
            {/* Minimal Formal Subheading (Updated Widths) */}
            <div className="flex items-center justify-center gap-4 text-white/30 text-xs md:text-sm font-mono tracking-[0.2em] uppercase mb-10">
               {/* UPDATED: Increased width to 100px */}
               <span className="h-px w-[100px] bg-black/10"></span>
               <span className="text-black/40">Structure & Specializations</span>
               <span className="h-px w-[100px] bg-black/10"></span>
            </div>
              ...
              return (
                <div key={subject.id} className="group flex flex-col gap-6">
                  ...
                  <div className="flex justify-between items-start border-b border-black/10 pb-6 group-hover:border-black/30 transition-colors">
                      ...
                      <div className="pt-1">
                          {isLocked ? (
                              ...
                              <div className="w-2 h-2 rounded-full bg-emerald-600 shadow-[0_0_10px_rgba(5,150,105,0.4)]" />
                          )}
                      </div>
                  </div>
                  ...
                  <div className="space-y-3">
                      {isLocked ? (
                          <div className="py-8 text-center bg-black/[0.02] rounded-lg border border-black/5">
                              <span className="font-serif text-sm italic text-black/40">Restricted Access</span>
                          </div>
